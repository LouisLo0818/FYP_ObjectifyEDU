                                ...
                                <div class="col">
                                    <div class="input-group flex-nowrap">
                                        ...
                                        <input type="text" class="form-control"
                                            :placeholder="options[currentQuestionIndex][0]" aria-label="Option A"
                                            disabled>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="input-group flex-nowrap">
                                        ...
                                        <!-- Bind the placeholder to the option at the current index -->
                                        <input type="text" class="form-control"
                                            :placeholder="options[currentQuestionIndex][1]" aria-label="Option B"
                                            disabled>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="input-group flex-nowrap">
                                        ...
                                        <!-- Bind the placeholder to the option at the current index -->
                                        <input type="text" class="form-control"
                                            :placeholder="options[currentQuestionIndex][2]" aria-label="Option C"
                                            disabled>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="input-group flex-nowrap">
                                        ...
                                        <!-- Bind the placeholder to the option at the current index -->
                                        <input type="text" class="form-control"
                                            :placeholder="options[currentQuestionIndex][3]" aria-label="Option D"
                                            disabled>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-3 course-content">
                    ...
                    <ul class="question-list">
                        <li v-for="(question, index) in questions" :key="question.question_id" class="question-item"
                            :class="{ 'clicked': currentQuestionIndex === index }"
                            @click="handleClick(question.question_id)">
